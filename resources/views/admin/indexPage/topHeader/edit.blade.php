                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('index.header_index')}}">الصفحة الرئيسية للموقع </a>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" method="post"
                                              action="{{route('update.header_index',$header_index->id)}}"
                                              id="vendorForm" enctype="multipart/form-data">
                                            @csrf
                                            <h4 class="form-section"><i
                                                    class="ft-home"></i> تعديل الرأسية
                                            </h4>
                                            <input type="hidden" name="id" value="{{$header_index->id}}">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="text-center">
                                                        <img src="{{$header_index->getPhoto($header_index->image->photo)}}"
                                                             alt="photo"
                                                             class="height-150">
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="header" class="form-control" placeholder="ابدأ بتفصيل ملابسك الان"
                                                                   name="header" value="{{$header_index->header}}">
                                                            @error('header')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" id="description" cols="3" rows="6"
                                                                      class="form-control"
                                                                      placeholder="نحن شركة زياد مشتهى للاقمشة ...">{{$header_index->description}}</textarea>
                                                        </div>
                                                        @error('description')
                                            ...
                                            <div class="form-actions">
                                                <a href="{{route('index.header_index')}}" class="btn btn-warning mr-1"
                                                   data-dismiss="modal"><i
                                                        class="la la-undo"></i> تراجع
                                                </a>
                                                <button class="btn btn-primary" id="updateHeaderIndex"><i
