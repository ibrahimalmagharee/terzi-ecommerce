...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> الألوان </h3>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewColor"><i class="la la-plus"></i>  اضافة لون جديد</a>
                                ...
                                <div class="card-content collapse show" id="viewColors">
                                    <div class="card-body card-dashboard table-responsive">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-3">
                                                <input type="text" data-color="0" name="color" id="color_filter" class="form-control" placeholder="اللون ">
                                            </div>
    ...
    <div class="modal fade modal-open" id="color-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-500">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i> اضافة اللون
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="colorForm" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="color" class="form-control" placeholder="الاحمر و مشتقاته "
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-primary" id="addColor"><i class="la la-save"></i> حفظ</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>هل أنت متأكد من حذف هذا اللون !!</h5>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#color_filter').on('keyup',function(){
                colorTable.column($(this).data('color')).search($(this).val()).draw();
