                                                ...
                                                <div class="form-group">
                                                    <div class="text-center">
                                                        @foreach($fabric->images as $image)
                                                            <img src="{{$image->getPhotoFabric($image->photo)}}" alt="photo"
                                                                 class="height-150">
                                                        @endforeach
                                                                    ...
                                                                    <optgroup label="الرجاء اختر التاجر">
                                                                        @isset($data['vendors'])
                                                                            @foreach($data['vendors'] as $vendor)
                                                                                <option value="{{$vendor->id}}" @if($fabric->product->vendor_id == $vendor->id) selected @endif>{{$vendor->name}}</option>
                                                                            @endforeach
                                                                        @endisset
                                                                    </optgroup>
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="colors[]" id="color_id" class="select2 form-control" style="width: 480px" multiple>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="offer" class="form-control" placeholder="لا يوجد عرض / نسبة الخصم :10"
                                                                       name="offer" value="{{$fabric->product->offer}}">
