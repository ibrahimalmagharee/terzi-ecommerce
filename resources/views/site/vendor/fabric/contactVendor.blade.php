        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent container pt-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link MontserratArabicLightPure text-warning" href="{{route('vendor.contactUsFabric')}}">اتصل بنا</a>
                    </li>
    ...
    <div class="container">
        ...
        <div class="row my-5">
            <div class="col-md-6 col-sm-12 text-right">
                ...
                <form method="post" action="{{route('vendor.saveContactUsFabric')}}" class="pr-1">
                    @csrf
