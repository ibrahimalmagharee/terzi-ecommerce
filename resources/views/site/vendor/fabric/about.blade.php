            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item mx-3">
                        <a class="nav-link MontserratArabicLightPure text-lg-warning" href="{{route('vendor.aboutFabric')}}"
                        >الرئيسية<span class="sr-only">(current)</span></a
                        >
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.addProductFabric')}}">إضافة منتج</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.viewProductsFabric')}}">المنتجات</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.purseFabric')}}"
                        >المحفظة
                        </a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link nav-vendor" href="{{route('vendor.getSearchPageFabric')}}"
                        ><i class="fa fa-search" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link MontserratArabicLightPure nav-vendor nav-vendor" href="{{route('vendor.contactUsFabric')}}">اتصل بنا</a>
                    </li>
