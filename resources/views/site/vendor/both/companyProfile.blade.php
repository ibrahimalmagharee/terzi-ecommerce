                    ...
                    @if($vendor->id == $design->product->vendor->id)
                        ...
                        <div class="col-md-4 col-sm-12 pr-0 pl-5 col-resp my-2">
                            <div class="card border-0 shadow-cust rounded-cust card-resp" style="width: 100%;">
                                <img src="{{$design->getPhoto($design->images[0]->photo)}}" class="card-img-top rounded-top" style="width: 100%; height: 280px;">
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <p class="card-text">{{$design->product->sales}} مبيعات</p>
                                        <a href="{{route('vendor.editProductDesign',$design->id)}}" class="btn btn-dark px-5 MontserratArabicLightPure editProduct">تعديل</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card border-0 shadow-cust rounded-cust card-resp" style="width: 100%;">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3">
                                            ...
                                            <a href="{{route('vendor.editProductFabric',$fabric->id)}}" class="btn btn-dark px-5 MontserratArabicLightPure editProduct">تعديل</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.editAccount', function () {
                ...
                $.get("{{route('vendor.editAccountBoth')}}", function (data) {
                    $('#id').val(data.id);
                    $('#name').val(data.name);
            ...
            $(document).on('click', '#editAccountVendor', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('vendor.updateAccountBoth') }}",
            ...
            $(document).on('click', '#editProfilePhoto', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{route('vendor.saveProfilePhotoBoth',$vendor->id)}}",
                    enctype: 'multipart/form-data',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '#editProfileHeaderCoverPhoto', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{route('vendor.saveProfileHeaderCoverBoth',$vendor->id)}}",
                    enctype: 'multipart/form-data',
                    data: formData,
                    processData: false,
                    contentType: false,
