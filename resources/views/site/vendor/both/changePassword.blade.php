    ...
    <div class="container my-5">
        ...
        <div class="row my-3">
            <div class="col-md-6 col-sm-12">
                <form method="post" action="{{route('vendor.updatePasswordBoth')}}" class="form justify-content-center px-lg-2 px-sm-2 mx-lg-5  ml-lg-2 reg-form-custom" _lpchecked="1">
                    @csrf
