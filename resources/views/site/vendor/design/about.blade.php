            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item  mx-3">
                        <a class="nav-link MontserratArabicLightPure text-lg-warning" href="{{route('vendor.aboutDesign')}}"
                        >الرئيسية<span class="sr-only">(current)</span></a
                        >
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.addProductDesign')}}">إضافة منتج</a>
                    </li>
                    <li class="nav-item  mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.viewProductsDesign')}}">المنتجات</a>
                    </li>
                    <li class="nav-item  mx-2">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.purseDesign')}}"
                        >المحفظة
                        </a>
                    </li>
                    <li class="nav-item  mx-2">
                        <a class="nav-link nav-vendor" href="{{route('vendor.getSearchPageDesign')}}"
                        ><i class="fa fa-search" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link MontserratArabicLightPure nav-vendor" href="{{route('vendor.contactUsDesign')}}">اتصل بنا</a>
                    </li>
