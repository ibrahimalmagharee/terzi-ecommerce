...
{{--                <img id="profile-header-cover" src="{{$vendor->getPhoto($vendor->headerCover->photo)}}" alt="" />--}}
            </div>
...
<div class="modal fade" id="photo_profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">تحديث صورة الملف الشخصي</h5>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.editAccount', function () {
                ...
                $.get("{{route('vendor.editAccountDesign')}}", function (data) {
                    $('#id').val(data.id);
                    $('#name').val(data.name);
            ...
            $(document).on('click', '#editAccountVendor', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('vendor.updateAccountDesign') }}",
            ...
            $(document).on('click', '#editProfilePhoto', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{route('vendor.saveProfilePhotoDesign',$vendor->id)}}",
                    enctype: 'multipart/form-data',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '#editProfileHeaderCoverPhoto', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{route('vendor.saveProfileHeaderCoverDesign',$vendor->id)}}",
                    enctype: 'multipart/form-data',
                    data: formData,
                    processData: false,
                    contentType: false,
