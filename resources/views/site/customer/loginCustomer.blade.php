            ...
            <div class="col-md-6 col-sm-12">
                <div class="container">
                    ...
                    <form method="post" action="{{route('check.customer.login')}}"
                          class="form justify-content-center px-lg-5 px-sm-2 mx-lg-5  ml-lg-5 needs-validation reg-form-custom" _lpchecked="1">
                        @csrf

                        <div class="row" style="height: 70px;">
                            <div role="group" class="col-md-12 col-sm-12">
                                <input name="email" id="email" value="{{old('email')}}" type="email" class="form-control" placeholder=" ">
                        ...
                        <div class="row mt-2" style="height: 70px;">
                            <div role="group" class="col-md-12 col-sm-12">
                                ...
                                <span class="log-after-input"><i toggle="#password" class="fa fa-eye toggle-password"
                                                                 aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="container ">
                        ...
                        <div class="row mx-5 p-4 justify-content-center">
                            لديك حساب بالفعل ؟ <span> <a href="{{route('customer.register.page')}}" class="text-warning MontserratArabicLight"> سجل الان</a></span>
                        </div>
                    </div>
                </div>
            </div>
